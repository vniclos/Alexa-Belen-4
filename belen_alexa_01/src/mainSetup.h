...
void fncSetupSoftFauxmoAlexa()
{
    ...
    g_NetFauxmoAlexa.addDevice("portal");
    g_NetFauxmoAlexa.addDevice("cielo");
    g_NetFauxmoAlexa.addDevice("fuego");
    g_NetFauxmoAlexa.addDevice("castillo");
    
    g_NetFauxmoAlexa.setState("portal", true, 128);
    g_NetFauxmoAlexa.setState("cielo", true, 128);
    g_NetFauxmoAlexa.setState("fuego", true, 128);
    g_NetFauxmoAlexa.setState("castillo", true, 128);
    ...
    g_NetFauxmoAlexa.onSetState([](unsigned char device_id, const char *device_name, bool state, unsigned char value)
                                {
                                    ...
                                    if ((strcmp(device_name, "portal") == 0))
                                    {
                                        relayId = 0;
                                    }
                                    if ((strcmp(device_name, "cielo") == 0))
                                    {
                                        relayId = 1;
                                    }
                                    if ((strcmp(device_name, "fuego") == 0))
                                    {
                                        relayId = 2;
                                    }
                                    if ((strcmp(device_name, "castillo") == 0))
                                    {
                                        relayId = 3;
                                    }
                                    if (state)
